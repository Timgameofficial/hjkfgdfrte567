...
(function (global) {
  ...
  function getState() {
    return MBStorage.getMerged(KEY, { xp: 0, interactions: 0, daily: null });
  }
  ...
  // local calendar day, not UTC — see dateutil.js for why toISOString()
  // rolls the day over at the wrong local time and breaks the daily prophecy
  function todayKey() { return MBDate.todayKey(); }
